...
public:
	...
	Tmap()
	{
		...
		first = iterator(sentinel);
		last = iterator(sentinel);
		root = sentinel;
	}
	~Tmap()
	{
...
/*************************************************function for map***************************************************/
	void insertNode(K _key, V _val)
	{
		...
		insertFixup(x);
		first = iterator(getMin());
		last = iterator(getMax());
	}
...
>>>>>>> 389b3a0c533d5059ea932e6e962bdb211ce56a90
